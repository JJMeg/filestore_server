...
func main() {
	username := "admin"
	token := "1a48f352ffe1e15d1c4611b22615df0092ec194c"
	filehash := "9f063a0b971bd90bbfa8f5d07f3becf32e1e7a18"
	...
	// 3. 请求分块上传接口
	filename := "/Users/jjmeg/go/src/filestore_server/data/incubator-echarts-3.8.5.tar.gz"
	...
	resp, err = http.PostForm(
		...
		url.Values{
			...
			"filehash": {filehash},
			"filesize": {"132489256"},
			"filename": {"incubator-echarts-3.8.5.tar.gz"},
			"uploadid": {uploadID},
		})
